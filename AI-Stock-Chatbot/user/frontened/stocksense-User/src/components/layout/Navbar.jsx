...
//         `http://127.0.0.1:8000/market/search_stock?search=${encodeURIComponent(q)}`
//       );
...
//             {/* Input */}
//             <span style={{ position: "absolute", left: 10, top: "50%", transform: "translateY(-50%)", color: "#556", zIndex: 1 }}>
//               {loading ? "⏳" : "🔍"}
//             </span>
//             <input
//               value={query}
...
//                 padding: "8px 12px 8px 32px", color: "#fff",
//                 fontFamily: "'Space Grotesk', sans-serif", fontSize: 13, width: 220,
...
//                   color: "#556", cursor: "pointer", fontSize: 14,
...
//                 overflowY: "auto",
//                 scrollbarWidth: "thin",
//                 scrollbarColor: "rgba(0,200,150,0.3) transparent",
//               }}>
...
//                     fontSize: 12, color: "#445", fontFamily: "monospace",
//                   }}>
//                     No stocks found
//                   </div>
//                 ) : results.map((stock, i) => {
...
//                             fontWeight: 700, color: "#dde", letterSpacing: 0.5,
//                           }}>
//                             {stock.symbol}
//                           </span>
//                           <span style={{
